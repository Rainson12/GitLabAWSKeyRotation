...
namespace GitLabApiClient
{
    ...
    public sealed class ProjectsClient : IProjectsClient
    {
        ...
        public async Task<Variable> UpdateVariableAsync(ProjectId projectId, string filterParam, UpdateProjectVariableRequest request)
        {
            Guard.NotNull(request, nameof(request));
            return await _httpFacade.Put<Variable>($"projects/{projectId}/variables/{request.Key}{filterParam}", request);
        }
